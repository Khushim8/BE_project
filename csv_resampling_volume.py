...
if __name__ == "__main__":
    input_text_filename = 'C://Users//khush_52iezzo//OneDrive//Documents//BE_project//condition+monitoring+of+hydraulic+systems//FS1.txt'
    output_csv_filename = 'FS1.csv'
    output_resampled_csv_filename = 'FS1_r.csv'
    
    # Convert text to CSV
    text_to_csv(input_text_filename, output_csv_filename)
    
    # Process CSV file
    average_values(output_csv_filename, output_resampled_csv_filename, 10, 600)
