...
if __name__ == "__main__":
    input_text_filename = 'C://Users//khush_52iezzo//OneDrive//Documents//BE_project//condition+monitoring+of+hydraulic+systems//TS1.txt'  # Provide the path to your input text file
    output_csv_filename = 'TS1.csv'  # Provide the desired output CSV filename
    output_resampled_csv_filename = 'TS1_r.csv'  # Provide the desired resampled output CSV filename
    
    # Convert text to CSV
    text_to_csv(input_text_filename, output_csv_filename)
    
    # Process CSV file
    average_values(output_csv_filename, output_resampled_csv_filename, 1, 60)  # Sampling rate is 1 Hz and 60 attributes per sensor
